...
from app.main import app, get_collection, get_generator
...
def client(
    ...
    """TestClient with stubbed collection and generator (no LLM network calls).
    ...
    The collection and generator are injected via dependency_overrides instead.
    """
